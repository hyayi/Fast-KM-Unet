...
def main():
    ...
    try:
        ...
        try:
            ...
            total_elements_int8 = 0
            
            for param in model.state_dict().values():
                total_elements_int8 += param.numel()
                
            print(f"총 저장 요소 수 (Total Elements in state_dict) (INT8): {total_elements_int8 / 1e6:.2f} M")
            print(f"  -> (INT8 가중치 + FP32 스케일/바이어스 등 포함)")
